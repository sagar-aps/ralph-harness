...
BUILDER_RESOLVED_MODEL="${BUILDER_MODEL:-$(ralph_command_model_values "$BUILDER_CMD" | head -n1)}"
REVIEWER_RESOLVED_MODEL="${REVIEWER_MODEL:-$(ralph_command_model_values "$REVIEWER_CMD" | head -n1)}"
